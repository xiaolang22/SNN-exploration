...
class StructureEvolutionParams:
    ...
    fitness_rank_weight: float = 0.10
    fitness_pattern_weight: float = 0.35
    fitness_raw_distance_weight: float = 0.20
    fitness_decode_weight: float = 0.35
    quick_decode_folds: int = 3
    fitness_activity_weight: float = 0.08
    fitness_burst_weight: float = 1.00
