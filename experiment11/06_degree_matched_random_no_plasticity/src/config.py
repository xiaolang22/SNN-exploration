...
class StructureEvolutionParams:
    ...
    fitness_plasticity_decode_weight: float = 0.45
    quick_decode_folds: int = 3
    fitness_activity_weight: float = 0.10
    fitness_burst_weight: float = 0.50
    ...
    burst_trial_active_fraction_threshold: float = 0.18
