...
class TopologyPlasticityParams:
    ...
    max_add_per_update: int = 96
    max_prune_per_update: int = 96
    max_edge_fraction_per_update: float = 0.004
    min_pair_cooccurrence: int = 4
    delay_window_ms: tuple[float, float] = (1.0, 20.0)
    class_specificity_weight: float = 0.35
    pair_count_weight: float = 1.0
    consistency_weight: float = 0.5
    distance_penalty: float = 0.03
    inactive_quantile: float = 0.2
    protect_min_in_degree: int = 1
    protect_min_out_degree: int = 1
    max_candidate_distance_mm: float = 2.1
