...
class TopologyPlasticityParams:
    ...
    max_add_per_update: int = 40
    max_prune_per_update: int = 40
    max_edge_fraction_per_update: float = 0.0018
    min_pair_cooccurrence: int = 4
    delay_window_ms: tuple[float, float] = (1.0, 16.0)
    class_specificity_weight: float = 0.65
    pair_count_weight: float = 0.65
    consistency_weight: float = 0.85
    distance_penalty: float = 0.09
    inactive_quantile: float = 0.18
    protect_min_in_degree: int = 1
    protect_min_out_degree: int = 1
    max_candidate_distance_mm: float = 1.4
